...
imagePath = 'TestImages/parrotTest.jpg' # Change this to any image you want to see results for 
modelFullPath = 'Graph/output_graph.pb'
labelsFullPath = 'Labels/output_labels.txt'
